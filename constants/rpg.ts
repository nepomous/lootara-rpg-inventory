...
export const DND5E_RACES = [
  ...
  { id: "dragonborn", label: "Draconato" },
  { id: "half_elf", label: "Meio-Elfo" },
  { id: "half_orc", label: "Meio-Orc" },
  { id: "tiefling", label: "Tiefling" },
  { id: "aasimar", label: "Aasimar" },
  { id: "goliath", label: "Golias" },
  { id: "orc", label: "Orc" },
  { id: "aarakocra", label: "Aarakocra" },
  { id: "genasi", label: "Genasi" },
  { id: "firbolg", label: "Firbolg" },
  { id: "tabaxi", label: "Tabaxi" },
  { id: "tortle", label: "Tortle" },
  { id: "kenku", label: "Kenku" },
  { id: "lizardfolk", label: "Lagartoide" },
  { id: "yuan_ti", label: "Yuan-ti" },
...
export const PF1E_RACES = [
  ...
  { id: "hobgoblin", label: "Hobgoblin" },
  { id: "kobold", label: "Kobold" },
  { id: "orc", label: "Orc" },
  { id: "dhampir", label: "Dhampir" },
  { id: "ifrit", label: "Ifrit" },
  { id: "oread", label: "Oread" },
  { id: "sylph", label: "Sílfide" },
  { id: "undine", label: "Ondina" },
  { id: "aasimar", label: "Aasimar" },
  { id: "tiefling", label: "Tiefling" },
  { id: "kitsune", label: "Kitsune" },
  { id: "nagaji", label: "Nagaji" },
  { id: "samsaran", label: "Samsaran" },
  { id: "tengu", label: "Tengu" },
  { id: "wayang", label: "Wayang" },
  { id: "catfolk", label: "Catfolk" },
  { id: "changeling", label: "Changeling" },
  { id: "fetchling", label: "Fetchling" },
  { id: "grippli", label: "Grippli" },
  { id: "merfolk", label: "Merfolk" },
  { id: "ratfolk", label: "Ratfolk" },
  { id: "strix", label: "Strix" },
  { id: "suli", label: "Suli" },
  { id: "vishkanya", label: "Vishkanya" },
  { id: "other", label: "Outro" },
] as const;
...
export const PF2E_RACES = [
  ...
  { id: "goblin", label: "Goblin" },
  { id: "halfling", label: "Halfling" },
  { id: "leshy", label: "Leshy" },
  { id: "ysoki", label: "Ysoki" },
  { id: "tengu", label: "Tengu" },
  { id: "kobold", label: "Kobold" },
  { id: "orc", label: "Orc" },
  { id: "hobgoblin", label: "Hobgoblin" },
  { id: "lizardfolk", label: "Lagartoide" },
  { id: "shoony", label: "Shoony" },
  { id: "sprite", label: "Sprite" },
  { id: "fetchling", label: "Fetchling" },
  { id: "automaton", label: "Autômato" },
  { id: "fleshwarp", label: "Fleshwarp" },
  { id: "grippli", label: "Grippli" },
  { id: "amurruni", label: "Amurruni" },
  { id: "android", label: "Androide" },
  { id: "skeleton", label: "Esqueleto" },
  { id: "strix", label: "Strix" },
  { id: "vanara", label: "Vanara" },
  { id: "kitsune", label: "Kitsune" },
  { id: "other", label: "Outro" },
] as const;
...
export function getRacesBySystem(
  system: RPGSystem,
